...
router.register(r'monitoring', MonitoringAnalyticsViewSet, basename='monitoring')
router.register(r'user-monitoring', UserMonitoringViewSet, basename='user-monitoring')
router.register(r'security-health', SecurityHealthCheckView, basename='security-health')
